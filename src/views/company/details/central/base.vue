    ...
    <div class="app-container">
        <div class="table-container">
            <div class="table-item">
                ...
                <div class="item-content">XXXXXX单位</div>
            </div>
            <div class="table-item">
            ...
            <div class="table-item">
                ...
                <div class="item-content">是</div>
            </div>
            <div class="table-item">
                <div class="item-title">所属央企集团</div>
                <div class="item-content">中国核工业集团有限公司</div>
            </div>
            <div class="table-item">
            ...
            <div class="table-item-line">
                <div class="line-item">
                    <div class="item-title">人员数量（截至2025.12）（人）</div>
                    <div class="item-content">666</div>
                </div>
                <div class="line-item">
                    <div class="item-title"><span> * </span><span>其中：女性（人）</span></div>
                    <div class="item-content">123</div>
                </div>
            </div>
            <div class="table-item">
