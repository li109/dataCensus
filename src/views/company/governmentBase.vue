    ...
    <div class="app-container">
        <div class="table-container">
            ...
            <div class="card-list" v-if="info.isPubDataOperate === '是'">
                <div class="card" v-for="(item, index) of info.operateUnitList" :key="index">
                    <div class="card-item">
                        <div class="card-title">授权运营单位名称</div>
                        <div class="card-content">{{ item.operateUnit }}</div>
                    </div>
                    <div class="card-item">
                        <div class="card-title">运营主体单位性质</div>
                        <div class="card-content">{{ item.operateUnitNature }}</div>
                    </div>
                    <div class="card-item">
